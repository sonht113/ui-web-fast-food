  ...
  return (
    <div className="Product-Order flex flex-col mt-10 px-3">
      <div className="List-Product-Order flex flex-col">
        <div className="Product-Order__Item flex items-center justify-around my-3 py-2 border shadow-lg rounded-2xl">
          ...
          <div className="Product-Order__Item-Title">
            <p className="Name mb-2 text-sm 2xl:text-lg">Cheese Burger</p>
          ...
          <div className="Product-Order__Item-Count">
            <p className="Count">
              x<span className="text-sm 2xl:text-lg"> {count}</span>
            </p>
          </div>
      ...
      <div className="Purchase flex justify-center mt-14">
          <div></div>
        <div>
        <button className="px-24 2xl:px-36 py-6 2xl:py-8 text-xl text-pink-600 font-semibold rounded-2xl border border-pink-300 hover:text-white hover:bg-pink-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2 duration-500">
          Purchase
        </button>
        </div>
      </div>
