...
function HeaderOrderSidebar() {
    ...
    return(
        <div className="flex items-center justify-between pt-5 pr-5" >
            ...
            <div className={isOpenModal ? "fixed w-full h-full top-0 left-0 z-[1000] flex items-center justify-center transition" : "fixed w-full h-full top-0 left-0 z-[1000] flex items-center justify-center invisible opacity-0 scale-75 transition"}>
                <a className="w-full h-full top-0 left-0 absolute bg-black opacity-60 z-[1] duration-100 transform delay-600" onClick={() => setIsOpenModal(false)}></a>
                <div className="modal relative max-w-[700px] w-full bg-white z-[2] border-t-[6px] border-pink-600 transform delay-300 duration-500">
                    ...
                    <div className="listProductOrder px-10 pb-10">
                        <div className="productOrderItem flex items-center gap-x-5 border pl-7">
                            ...
                            <div className="flex button-group">
                                ...
                                <span className="bg-pink-600 relative z-[1] text-white text-sm py-3 px-1 opacity-0 transform transition duration-300 -translate-x-3">Remove product</span>
                            </div>
                        </div>
                    </div>
                </div>
